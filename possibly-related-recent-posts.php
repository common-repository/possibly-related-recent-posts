...
Plugin URI: http://www.travisballard.com/wordpress/possibly-related-recent-posts-wordpress-plugin/
...
Version: 1.3
        ...
        Copyright (c) 2008 Travis Ballard (http://www.travisballard.com)
*/
...
function possibly_related_recent_posts ( $related_content ) {
	...
	if ( ! is_page () && $prrp['on_home'] != 'false' ) :
		...
		endforeach;
		$related = '<p><strong>Possibly Related Posts:</strong></p>' . "\r\n";
		$related .= '<ul>' . "\r\n";
		$related_links = '';
